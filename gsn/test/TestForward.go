...
func GsnBridgeFoo(gsnParams *gsn.CallOpts, args ...interface{}) (txHash common.Hash, err error) {
	return gsn.BridgeExecutor(gsnParams, __contractTestForwardSourceABI, "foo", args...)
}

func GsnBridgeTestExecute(gsnParams *gsn.CallOpts, args ...interface{}) (txHash common.Hash, err error) {
	return gsn.BridgeExecutor(gsnParams, __contractTestForwardSourceABI, "testExecute", args...)
}
