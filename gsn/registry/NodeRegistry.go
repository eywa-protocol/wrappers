...
func GsnBridgeInitialize2(
	__gsnCaller gsn.GsnCaller,
	__chainId *big.Int,
	__signer *ecdsa.PrivateKey,
	__contractAddress common.Address, _EYWA common.Address, _forwarder common.Address) (txHash common.Hash, err error) {
	...
	__fRequest, err := __contractABI.Pack("initialize2", _EYWA, _forwarder)
	if err != nil {
		return
	}
