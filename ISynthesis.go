...
// BurnSyntheticToken is a paid mutator transaction binding the contract method 0x451c7635.
//
// Solidity: function burnSyntheticToken(address tokenSynth, uint256 amount, address from, address to, (address,address,uint256) params) returns()
func (_ISynthesis *ISynthesisTransactor) BurnSyntheticToken(opts *bind.TransactOpts, tokenSynth common.Address, amount *big.Int, from common.Address, to common.Address, params ISynthesisSynthParams) (*types.Transaction, error) {
	return _ISynthesis.contract.Transact(opts, "burnSyntheticToken", tokenSynth, amount, from, to, params)
}
func (_ISynthesis *ISynthesisTransactor) BurnSyntheticTokenOverGsn(opts *bind.TransactOpts, tokenSynth common.Address, amount *big.Int, from common.Address, to common.Address, params ISynthesisSynthParams) (common.Hash, error) {
	return GsnExecutor(_ISynthesis.gsn, ISynthesisMetaData.ABI, "burnSyntheticToken", tokenSynth, amount, from, to, params)
}

// BurnSyntheticToken is a paid mutator transaction binding the contract method 0x451c7635.
//
// Solidity: function burnSyntheticToken(address tokenSynth, uint256 amount, address from, address to, (address,address,uint256) params) returns()
func (_ISynthesis *ISynthesisSession) BurnSyntheticToken(tokenSynth common.Address, amount *big.Int, from common.Address, to common.Address, params ISynthesisSynthParams) (*types.Transaction, error) {
	return _ISynthesis.Contract.BurnSyntheticToken(&_ISynthesis.TransactOpts, tokenSynth, amount, from, to, params)
}
func (_ISynthesis *ISynthesisSession) BurnSyntheticTokenOverGsn(tokenSynth common.Address, amount *big.Int, from common.Address, to common.Address, params ISynthesisSynthParams) (common.Hash, error) {
	return _ISynthesis.Contract.BurnSyntheticTokenOverGsn(&_ISynthesis.TransactOpts, tokenSynth, amount, from, to, params)
}

// BurnSyntheticToken is a paid mutator transaction binding the contract method 0x451c7635.
//
// Solidity: function burnSyntheticToken(address tokenSynth, uint256 amount, address from, address to, (address,address,uint256) params) returns()
func (_ISynthesis *ISynthesisTransactorSession) BurnSyntheticToken(tokenSynth common.Address, amount *big.Int, from common.Address, to common.Address, params ISynthesisSynthParams) (*types.Transaction, error) {
	return _ISynthesis.Contract.BurnSyntheticToken(&_ISynthesis.TransactOpts, tokenSynth, amount, from, to, params)
}
func (_ISynthesis *ISynthesisTransactorSession) BurnSyntheticTokenOverGsn(tokenSynth common.Address, amount *big.Int, from common.Address, to common.Address, params ISynthesisSynthParams) (common.Hash, error) {
	return _ISynthesis.Contract.BurnSyntheticTokenOverGsn(&_ISynthesis.TransactOpts, tokenSynth, amount, from, to, params)
}
