...
func GsnBridgeAddContractBind(gsnParams *gsn.CallOpts, args ...interface{}) (txHash common.Hash, err error) {
	return gsn.BridgeExecutor(gsnParams, __contractBridgeSourceABI, "addContractBind", args...)
}

func GsnBridgeDaoTransferOwnership(gsnParams *gsn.CallOpts, args ...interface{}) (txHash common.Hash, err error) {
	return gsn.BridgeExecutor(gsnParams, __contractBridgeSourceABI, "daoTransferOwnership", args...)
}

func GsnBridgeDaoUpdateEpochRequest(gsnParams *gsn.CallOpts, args ...interface{}) (txHash common.Hash, err error) {
	return gsn.BridgeExecutor(gsnParams, __contractBridgeSourceABI, "daoUpdateEpochRequest", args...)
}

func GsnBridgeInitialize(gsnParams *gsn.CallOpts, args ...interface{}) (txHash common.Hash, err error) {
	return gsn.BridgeExecutor(gsnParams, __contractBridgeSourceABI, "initialize", args...)
}

func GsnBridgeReceiveRequestV2(gsnParams *gsn.CallOpts, args ...interface{}) (txHash common.Hash, err error) {
	return gsn.BridgeExecutor(gsnParams, __contractBridgeSourceABI, "receiveRequestV2", args...)
}

func GsnBridgeTransmitRequestV2(gsnParams *gsn.CallOpts, args ...interface{}) (txHash common.Hash, err error) {
	return gsn.BridgeExecutor(gsnParams, __contractBridgeSourceABI, "transmitRequestV2", args...)
}

func GsnBridgeTransmitRequestV2ToSolana(gsnParams *gsn.CallOpts, args ...interface{}) (txHash common.Hash, err error) {
	return gsn.BridgeExecutor(gsnParams, __contractBridgeSourceABI, "transmitRequestV2ToSolana", args...)
}

func GsnBridgeUpdateEpoch(gsnParams *gsn.CallOpts, args ...interface{}) (txHash common.Hash, err error) {
	return gsn.BridgeExecutor(gsnParams, __contractBridgeSourceABI, "updateEpoch", args...)
}
