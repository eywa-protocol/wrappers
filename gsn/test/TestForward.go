...
func Foo(gsnParams *gsn.CallOpts, args ...interface{}) (txHash common.Hash, err error) {
	...
	return wrappers.GsnExecutor(gsnCallParams, __contractTestForwardSourceABI, "foo", args...)
}
...
func TestExecute(gsnParams *gsn.CallOpts, args ...interface{}) (txHash common.Hash, err error) {
	...
	return wrappers.GsnExecutor(gsnCallParams, __contractTestForwardSourceABI, "testExecute", args...)
}
